...
/**
 * Contains all types of <code>Income</code> that can occur in the file that is
 * read in.
 */
public enum Income
{
	 ...
	 * @return <code>Income</code> constant, <code>null</code> if id is not
	 *         contained
	 */
	...
	/**
	 * Returns the <code>Income</code> constant that matches with the given
	 * token.
	 * 
	 * @param token
	 *            that is searched for
	 * @return <code>Income</code> constant, <code>null</code> if token is not
	 *         contained
	 */
	...
	/**
	 * Returns the correct <code>Income</code> token for a single given value
	 * (e.g. class 3000-3999 for the value 3412)
	 * 
	 * @param intValue
	 *            an <code>int</code> that should be classified
	 * @return the token representing the correct <code>Income</code> for the
	 *         given intValue
	 */
